...
export const INITIAL_SITES: InternshipSite[] = [
  ...
  },
  {
    ...
    description: { th: "บริษัทพัฒนาซอฟต์แวร์และระบบคลาวด์", en: "Software development and cloud solutions company.", ar: "شركة تطوير البرمجيات وحلول السحابة.", ms: "Syarikat pembangunan perisianและ penyelesaian awan." },
